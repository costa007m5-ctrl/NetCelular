...
const nvc = StyleSheet.create({
  wrap: {
    ...
    overflow: "hidden",
    ...Platform.select({
      web: { boxShadow: "0 8px 22px rgba(0,0,0,0.55)" } as any,
      default: {
  ...
  imgWrap: { width: "100%", aspectRatio: 1.9, backgroundColor: "#1a1a1d", overflow: "hidden" },
  logoOverlay: {
  ...
  // ── Info section ──────────────────────────────────────────────
  info: { paddingHorizontal: 16, paddingTop: 14, paddingBottom: 16, backgroundColor: "#141417" },
  infoChipsRow: {
