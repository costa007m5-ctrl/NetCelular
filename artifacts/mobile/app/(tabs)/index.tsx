...
const styles = StyleSheet.create({
  ...
  streamingLogo: { width: "96%", height: 62, alignSelf: "center" },
  streamingName: { fontSize: 17, fontWeight: "900", letterSpacing: 0.5, textAlign: "center" },
  streamingTagline: { fontSize: 8, fontWeight: "700", letterSpacing: 1.5, textAlign: "center" },
